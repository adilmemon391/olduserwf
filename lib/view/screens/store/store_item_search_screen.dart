      ...
      builder: (storeController) {
        return Scaffold(
                ...
                child: Row(children: [
                  ...
                  Expanded(child: TextField(
                    ...
                    onSubmitted: (text) => Get.find<StoreController>().getStoreSearchItemList(
                      _searchController.text.trim(), widget.storeID, 1, Get.find<StoreController>().searchText,
                    ),
                  )),
          ...
          body: SingleChildScrollView(
            ...
            //       items: storeController.storeSearchItemModel != null ? storeController.storeSearchItemModel!.items!.where((item) => item.name.toLowerCase().contains(_searchController.text.toLowerCase())).toString() :null,
            //       inStorePage: true,
            //   ),
            // ),
              child: PaginatedListView(
