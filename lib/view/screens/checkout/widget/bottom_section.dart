        ...
        child: Column(
          children: [
            ...
            storeId == null ? Row(mainAxisAlignment:MainAxisAlignment.spaceBetween,
              ...
              // Text('(-) ${PriceConverter.convertPrice(discount)??'N/A'}', style: robotoRegular, textDirection: TextDirection.ltr),
              Text('(-) ${PriceConverter.convertPrice(discount)}', style: robotoRegular, textDirection: TextDirection.ltr),
            ]) : const SizedBox(),
            const SizedBox(height:Dimensions.paddingSizeSmall),

            (couponController.discount! > 0 || couponController.freeDelivery) ? Column(
                children: [
